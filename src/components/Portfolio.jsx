      ...
      <div className="projects-container">
        ...
        <div className='project-cards'>
          {projectData && projectData.map((project) => (
            <Link href={project.link} className={`project-card ${project.gradient}`} key={project.id}>
              <Image src={project.image} alt={project.title} layout="responsive" objectFit="cover" height={100} width={100} />
              {/* <Image src={project.image} alt={project.title} width={340} height={152} /> */}
              <div className="project-header">
                {/* <i className="fa-regular fa-folder-open folder-icon"></i> */}
                {/* <div className="small-icons">
                  {project.figmaLink ? <a href={project.figmaLink}><i className="fa-brands fa-github"></i></a> : ''}
                  {project.webLink ? <a href={project.webLink}><i className="fa-brands fa-github"></i></a> : ''}
                </div> */}
              </div>
              <div className='card-description'>
                ...
                <div className='icon-links'>
                  <div>
                    {project.figmaLink ? <Link href={project.figmaLink} className='linkicon' target="_blank"><svg width="16" height="25" viewBox="0 0 34 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_2612_405)">
                    ...
                    {project.webLink ? <Link href={project.webLink} target="_blank" className=''><svg width="25" height="25" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  {/* <Link href={project.link} className='cta-btn'>See more</Link> */}
                </div>
              </div>
            </Link>
          ))
