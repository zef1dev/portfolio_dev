            ...
            <Link href={project.link} className={`project-card ${project.gradient}`} key={project.id}>
              ...
              <div className='card-description'>
                ...
                <div className='icon-links'>
                  <div>
                    {project.figmaLink ? <Link href={project.figmaLink} className='linkicon'><svg width="16" height="25" viewBox="0 0 34 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {project.webLink ? <Link href={project.webLink} className=''><svg width="25" height="25" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
